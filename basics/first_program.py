...
# This is simple, but print function does not just do this; it also takes parameters.
...
# try the above command it will about it in the end
...
# now that you have completed a print statement, proceed to <vars & esc_chars>
